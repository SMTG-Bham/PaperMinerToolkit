...
RECIPES_PATH = PACKAGE_DIR / 'resources' / 'recipes.json'
...
def load_recipe(recipe_name: str) -> _Recipe:
    ...
    try:
        ...
        raise FileNotFoundError('The recipes.json file is missing. Please reinstall PaperMinerToolkit.')
    except json.JSONDecodeError as e:
        raise ValueError('The recipes.json file is not valid JSON. Please reinstall PaperMinerToolkit.') from e
