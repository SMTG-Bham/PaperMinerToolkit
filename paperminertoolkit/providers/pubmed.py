"""Request helpers for the NCBI E-utilities API used by PaperMinerToolkit.

This module centralizes PubMed and PubMed Central HTTP details and the mapping
from PubMed article records onto PaperMinerToolkit's paper schema, so search,
...
def article_to_paper(record: ET.Element) -> _PubMedRecord:
    """Map one PubMed record onto PaperMinerToolkit's paper schema.
