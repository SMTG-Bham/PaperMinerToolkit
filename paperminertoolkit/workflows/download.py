...
This module powers ``pmt download``. It can fetch Elsevier, PubMed Central
...
def _unpaywall_email(settings: Mapping[str, str] | None = None) -> str | None:
    ...
    settings : Mapping[str, str] or None, optional
        Loaded PaperMinerToolkit settings.
...
def _pubmed_identifier(paper: Mapping[str, Any]) -> str | None:
    ...
    :func:`paperminertoolkit.providers.pubmed.resolve_pmid`, at the cost of one lookup.
...
def _arxiv_identifier(paper: Mapping[str, Any]) -> str | None:
    ...
    wrong record; :func:`paperminertoolkit.providers.arxiv.resolve_arxiv_id` offers that
