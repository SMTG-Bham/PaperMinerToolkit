...
from paperminertoolkit.providers import arxiv
from paperminertoolkit.providers import base as provider
from paperminertoolkit.providers import registry
from paperminertoolkit.providers import biorxiv
from paperminertoolkit.providers import chemrxiv
from paperminertoolkit.providers import crossref as crossref_client
from paperminertoolkit.providers import medrxiv
from paperminertoolkit.providers import openalex
from paperminertoolkit.providers import pubmed
from paperminertoolkit.corpus.database import (connect,
                                 ...
                                 utc_now,
                                 write_enrichment)
from paperminertoolkit.corpus.metadata import clean_doi, crossref_fields as crossref_metadata_fields
...
def _pubmed_fields(article: Mapping[str, Any]) -> _Fields:
    ...
    article : Mapping[str, Any]
        Article mapping produced by :func:`paperminertoolkit.providers.pubmed.article_to_paper`.
...
def _arxiv_fields(entry: Mapping[str, Any]) -> _Fields:
    ...
    entry : Mapping[str, Any]
        Entry mapping produced by :func:`paperminertoolkit.providers.arxiv.entry_to_paper`.
...
def _medrxiv_fields(entry: Mapping[str, Any]) -> _Fields:
    ...
    ----------
    entry : Mapping[str, Any]
        Record mapping produced by :func:`paperminertoolkit.providers.medrxiv.record_to_paper`.
...
def _medrxiv_subject_rows(paper_id: str, entry: Mapping[str, Any] | None) -> list[_Record]:
    ...
    entry : Mapping[str, Any] or None
        ...
        :func:`paperminertoolkit.providers.medrxiv.record_to_paper`.
...
def _biorxiv_fields(entry: Mapping[str, Any]) -> _Fields:
    ...
    ----------
    entry : Mapping[str, Any]
        Record mapping produced by :func:`paperminertoolkit.providers.biorxiv.record_to_paper`.
...
def _biorxiv_subject_rows(paper_id: str, entry: Mapping[str, Any] | None) -> list[_Record]:
    ...
    entry : Mapping[str, Any] or None
        Record mapping produced by
        :func:`paperminertoolkit.providers.biorxiv.record_to_paper`.
...
def _chemrxiv_fields(entry: Mapping[str, Any]) -> _Fields:
    ...
    it is normalized by :func:`paperminertoolkit.providers.chemrxiv.normalize_chemrxiv_doi`
    rather than by :func:`paperminertoolkit.corpus.metadata.clean_doi` alone.

    Parameters
    ----------
    entry : Mapping[str, Any]
        Record mapping produced by
        :func:`paperminertoolkit.providers.chemrxiv.record_to_paper`.
...
def _enrich_from_crossref_message(conn: sqlite3.Connection,
    ...
    This is the write path that keeps ``pmt import pdfs`` from discarding the
