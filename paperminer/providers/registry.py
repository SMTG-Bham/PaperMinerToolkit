"""The data sources PaperMiner knows about, and what each can be used for.

A source name used to be written out in eight places: a set in
:mod:`paperminer.workflows.search`, a tuple in :mod:`paperminer.workflows.enrichment`, two sets
in :mod:`paperminer.workflows.download`, three hand-typed ``click.Choice`` lists in
:mod:`paperminer.cli`, and a literal open-access set written twice inside one
...
:mod:`paperminer.settings`, which several source modules import.
...
class Source:
    """One data source and the capabilities PaperMiner can use it for.
...
def _source(name: str,
    ...
    **rest : object
    ...
    Source
        The registry entry.
    """
    return Source(name=name, label=label, module=f'paperminer.providers.{module}',
...
SOURCES: dict[str, Source] = {
    entry.name: entry for entry in (
        _source('crossref', 'Crossref', 'crossref', [ENRICH],
                ...
                setup_command='pm config crossref-email',
                enrich_handler='paperminer.workflows.enrichment:_fetch_crossref'),
        _source('openalex', 'OpenAlex', 'openalex', [SEARCH, ENRICH, PDF, ABSTRACT],
                identifier_column='openalex_id', credential='openalex_api_key',
                credential_env='OPENALEX_API_KEY', setup_command='pm config openalex-key',
                open_access=True,
                search_handler='paperminer.workflows.search:openalex_search',
                enrich_handler='paperminer.workflows.enrichment:_fetch_openalex',
                pdf_handler='paperminer.workflows.download:_download_openalex_pdf',
                abstract_handler='paperminer.workflows.download:_download_openalex_abstract',
                abstract_reachable='paperminer.workflows.download:_openalex_identifier'),
        _source('pubmed', 'PubMed', 'pubmed', [SEARCH, ENRICH, PDF, TEXT, ABSTRACT],
                identifier_column='pmid', credential='ncbi_api_key',
                credential_env='NCBI_API_KEY', setup_command='pm config ncbi-key',
                search_handler='paperminer.workflows.search:pubmed_search',
                enrich_handler='paperminer.workflows.enrichment:_fetch_pubmed',
                pdf_handler='paperminer.workflows.download:_download_pubmed_pdf',
                text_handler='paperminer.workflows.download:_download_pmc_text',
                text_reachable='paperminer.workflows.download:_should_try_pmc_text',
                abstract_handler='paperminer.workflows.download:_download_pubmed_abstract',
                abstract_reachable='paperminer.workflows.download:_pubmed_abstract_reachable'),
        _source('elsevier', 'Elsevier', 'elsevier', [SEARCH, PDF, TEXT, ABSTRACT],
                identifier_column='elsevier_link', credential='elsevier_api_key',
                credential_env='ELSEVIER_API_KEY', setup_command='pm config elsevier-key',
                credential_required=True,
                search_handler='paperminer.workflows.search:_elsevier_search',
                pdf_handler='paperminer.workflows.download:_download_elsevier_pdf',
                text_handler='paperminer.workflows.download:_download_elsevier_text',
                text_reachable='paperminer.workflows.download:_should_try_elsevier_text',
                abstract_handler='paperminer.workflows.download:_download_elsevier_abstract',
                abstract_reachable='paperminer.workflows.download:_elsevier_abstract_reachable'),
        _source('core', 'CORE', 'core', [SEARCH, PDF, ABSTRACT],
                identifier_column='core_id', credential='core_api_key',
                credential_env='CORE_API_KEY', setup_command='pm config core-key',
                credential_required=True, open_access=True,
                search_handler='paperminer.workflows.search:core_search',
                pdf_handler='paperminer.workflows.download:_download_core_pdf',
                abstract_handler='paperminer.workflows.download:_download_core_abstract',
                abstract_reachable='paperminer.workflows.download:_core_abstract_reachable'),
        _source('unpaywall', 'Unpaywall', 'unpaywall', [PDF],
                credential='unpaywall_email', credential_env='UNPAYWALL_EMAIL',
                setup_command='pm config unpaywall-email', credential_required=True,
                open_access=True,
                pdf_handler='paperminer.workflows.download:_download_unpaywall_pdf'),
        _source('arxiv', 'arXiv', 'arxiv', [SEARCH, ENRICH, PDF, ABSTRACT],
                identifier_column='arxiv_id', open_access=True,
                search_handler='paperminer.workflows.search:arxiv_search',
                enrich_handler='paperminer.workflows.enrichment:_fetch_arxiv',
                pdf_handler='paperminer.workflows.download:_download_arxiv_pdf',
                abstract_handler='paperminer.workflows.download:_download_arxiv_abstract',
                abstract_reachable='paperminer.workflows.download:_arxiv_identifier'),
        _source('medrxiv', 'medRxiv', 'medrxiv', [SEARCH, ENRICH, PDF, TEXT, ABSTRACT],
                identifier_column='medrxiv_doi', open_access=True,
                search_handler='paperminer.workflows.search:medrxiv_search',
                enrich_handler='paperminer.workflows.enrichment:_fetch_medrxiv',
                pdf_handler='paperminer.workflows.download:_download_medrxiv_pdf',
                text_handler='paperminer.workflows.download:_download_medrxiv_text',
                text_reachable='paperminer.workflows.download:_should_try_medrxiv_text',
                abstract_handler='paperminer.workflows.download:_download_medrxiv_abstract',
                abstract_reachable='paperminer.workflows.download:_medrxiv_identifier'),
        _source('biorxiv', 'bioRxiv', 'biorxiv', [SEARCH, ENRICH, PDF, TEXT, ABSTRACT],
                identifier_column='biorxiv_doi', open_access=True,
                search_handler='paperminer.workflows.search:biorxiv_search',
                enrich_handler='paperminer.workflows.enrichment:_fetch_biorxiv',
                pdf_handler='paperminer.workflows.download:_download_biorxiv_pdf',
                text_handler='paperminer.workflows.download:_download_biorxiv_text',
                text_reachable='paperminer.workflows.download:_should_try_biorxiv_text',
                abstract_handler='paperminer.workflows.download:_download_biorxiv_abstract',
                abstract_reachable='paperminer.workflows.download:_biorxiv_identifier'),
        _source('chemrxiv', 'chemRxiv', 'chemrxiv', [SEARCH, ENRICH, PDF, ABSTRACT],
                identifier_column='chemrxiv_doi', open_access=True,
                search_handler='paperminer.workflows.search:chemrxiv_search',
                enrich_handler='paperminer.workflows.enrichment:_fetch_chemrxiv',
                pdf_handler='paperminer.workflows.download:_download_chemrxiv_pdf',
                abstract_handler='paperminer.workflows.download:_download_chemrxiv_abstract',
                abstract_reachable='paperminer.workflows.download:_chemrxiv_identifier'),
    )
}
...
def names(capability: str) -> tuple[str, ...]:
    ...
    ------
    ValueError
        If ``capability`` is not one PaperMiner knows.
    """
