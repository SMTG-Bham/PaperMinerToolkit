"""Shared HTTP plumbing for the PaperMiner data-source clients.

Every data source PaperMiner reads from -- Crossref, OpenAlex, PubMed,
...
from paperminer._version import __version__

USER_AGENT = f'PaperMiner/{__version__}'
...
def user_agent(mailto: str = '') -> str:
    ...
    -------
    str
        User agent string identifying PaperMiner and its version.
    """
...
def default_headers(mailto: str = '') -> dict[str, str]:
    ...
    -------
    dict[str, str]
        Headers identifying PaperMiner and its version.
    """
