...
:mod:`paperminer.search`, a tuple in :mod:`paperminer.enrichment`, two sets
in :mod:`paperminer.download`, three hand-typed ``click.Choice`` lists in
...
def _source(name: str,
    ...
    **rest : object
    ...
    Source
        The registry entry.
    """
    return Source(name=name, label=label, module=f'paperminer.{module}',
...
SOURCES: dict[str, Source] = {
    entry.name: entry for entry in (
        _source('crossref', 'Crossref', 'crossref', [ENRICH],
                ...
                enrich_handler='paperminer.enrichment:_fetch_crossref'),
        _source('openalex', 'OpenAlex', 'openalex', [SEARCH, ENRICH, PDF, ABSTRACT],
                ...
                open_access=True,
                search_handler='paperminer.search:openalex_search',
                enrich_handler='paperminer.enrichment:_fetch_openalex',
                pdf_handler='paperminer.download:_download_openalex_pdf',
                abstract_handler='paperminer.download:_download_openalex_abstract',
                abstract_reachable='paperminer.download:_openalex_identifier'),
        _source('pubmed', 'PubMed', 'pubmed', [SEARCH, ENRICH, PDF, TEXT, ABSTRACT],
                ...
                search_handler='paperminer.search:pubmed_search',
                enrich_handler='paperminer.enrichment:_fetch_pubmed',
                pdf_handler='paperminer.download:_download_pubmed_pdf',
                text_handler='paperminer.download:_download_pmc_text',
                text_reachable='paperminer.download:_should_try_pmc_text',
                abstract_handler='paperminer.download:_download_pubmed_abstract',
                abstract_reachable='paperminer.download:_pubmed_abstract_reachable'),
        _source('elsevier', 'Elsevier', 'elsevier', [SEARCH, PDF, TEXT, ABSTRACT],
                ...
                search_handler='paperminer.search:_elsevier_search',
                pdf_handler='paperminer.download:_download_elsevier_pdf',
                text_handler='paperminer.download:_download_elsevier_text',
                text_reachable='paperminer.download:_should_try_elsevier_text',
                abstract_handler='paperminer.download:_download_elsevier_abstract',
                abstract_reachable='paperminer.download:_elsevier_abstract_reachable'),
        _source('core', 'CORE', 'core', [SEARCH, PDF, ABSTRACT],
                ...
                search_handler='paperminer.search:core_search',
                pdf_handler='paperminer.download:_download_core_pdf',
                abstract_handler='paperminer.download:_download_core_abstract',
                abstract_reachable='paperminer.download:_core_abstract_reachable'),
        _source('unpaywall', 'Unpaywall', 'unpaywall', [PDF],
                ...
                open_access=True,
                pdf_handler='paperminer.download:_download_unpaywall_pdf'),
        _source('arxiv', 'arXiv', 'arxiv', [SEARCH, ENRICH, PDF, ABSTRACT],
                identifier_column='arxiv_id', open_access=True,
                search_handler='paperminer.search:arxiv_search',
                enrich_handler='paperminer.enrichment:_fetch_arxiv',
                pdf_handler='paperminer.download:_download_arxiv_pdf',
                abstract_handler='paperminer.download:_download_arxiv_abstract',
                abstract_reachable='paperminer.download:_arxiv_identifier'),
        _source('medrxiv', 'medRxiv', 'medrxiv', [SEARCH, ENRICH, PDF, TEXT, ABSTRACT],
                identifier_column='medrxiv_doi', open_access=True,
                search_handler='paperminer.search:medrxiv_search',
                enrich_handler='paperminer.enrichment:_fetch_medrxiv',
                pdf_handler='paperminer.download:_download_medrxiv_pdf',
                text_handler='paperminer.download:_download_medrxiv_text',
                text_reachable='paperminer.download:_should_try_medrxiv_text',
                abstract_handler='paperminer.download:_download_medrxiv_abstract',
                abstract_reachable='paperminer.download:_medrxiv_identifier'),
        _source('biorxiv', 'bioRxiv', 'biorxiv', [SEARCH, ENRICH, PDF, TEXT, ABSTRACT],
                identifier_column='biorxiv_doi', open_access=True,
                search_handler='paperminer.search:biorxiv_search',
                enrich_handler='paperminer.enrichment:_fetch_biorxiv',
                pdf_handler='paperminer.download:_download_biorxiv_pdf',
                text_handler='paperminer.download:_download_biorxiv_text',
                text_reachable='paperminer.download:_should_try_biorxiv_text',
                abstract_handler='paperminer.download:_download_biorxiv_abstract',
                abstract_reachable='paperminer.download:_biorxiv_identifier'),
        _source('chemrxiv', 'chemRxiv', 'chemrxiv', [SEARCH, ENRICH, PDF, ABSTRACT],
                identifier_column='chemrxiv_doi', open_access=True,
                search_handler='paperminer.search:chemrxiv_search',
                enrich_handler='paperminer.enrichment:_fetch_chemrxiv',
                pdf_handler='paperminer.download:_download_chemrxiv_pdf',
                abstract_handler='paperminer.download:_download_chemrxiv_abstract',
                abstract_reachable='paperminer.download:_chemrxiv_identifier'),
    )
}
