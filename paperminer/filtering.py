...
from paperminer.corpus import connect, get_asset, paper_rows, utc_now
from paperminer.documents import read_pdf_bytes, trim_reference_section
...
def topic_filter_staleness(conn: sqlite3.Connection) -> dict[str, bool]:
    ...
    if not filters:
        return {}
    from paperminer.topics import topic_corpus_fingerprint
