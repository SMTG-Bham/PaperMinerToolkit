...
from paperminer.corpus import connect, get_asset
from paperminer.documents import trim_reference_section
    ...
    with tempfile.TemporaryDirectory(prefix='paperminer-topic-store-') as temporary_dir:
        ...
        with connect(db_path) as conn, sqlite3.connect(staging_path) as staging:
            ...
            try:
                ...
                raise
    try:
        from paperminer.filtering import refresh_topic_filters
