...
from paperminer.extraction.compression import compression_config, maybe_compress_text
from paperminer.corpus.documents import (extract_pdf_images,
                                    read_document_text,
                                    read_pdf_text)
from paperminer.corpus.database import PIPELINE_COLUMNS, connect, get_asset, paper_rows, upsert_paper
from paperminer.extraction.extract import build_scrape_prompt, combine_material_records, scrape_images, scrape_text, token_length
from paperminer.corpus.filtering import active_filter_stack, current_filter_statuses, filter_expression, filter_overview
from paperminer.extraction.models import ModelConfig
from paperminer.extraction.recipes import load_recipe
from paperminer.extraction.tokenizer import _ModelConfigSource, prompt_token_reserve, usable_input_token_limit
...
def scrape_papers(db_path: str = 'papers.db',
    ...
    with connect(db_path) as conn:
        ...
        with tempfile.TemporaryDirectory(prefix='paperminer-scrape-') as temp_dir:
