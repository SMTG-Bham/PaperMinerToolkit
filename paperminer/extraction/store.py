...
from paperminer.corpus.database import connect, paper_rows, upsert_paper
from paperminer.extraction.extract import convert_units
from paperminer.extraction.models import ModelConfig
from paperminer.extraction.recipes import canonical_match, field_columns, load_recipe
...
def store_results(db_path: str | PathLike[str] = 'papers.db',
    ...
    preview_path = _temporary_path(output_path.parent, '.paperminer-converted-', '.csv')
    try:
