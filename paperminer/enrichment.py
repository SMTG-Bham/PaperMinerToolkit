...
from paperminer import arxiv
from paperminer import provider
from paperminer import sources as registry
from paperminer import biorxiv
from paperminer import chemrxiv
from paperminer import crossref as crossref_client
from paperminer import medrxiv
from paperminer import openalex
from paperminer import pubmed
from paperminer.corpus import (connect,
                                 ...
                                 utc_now,
                                 write_enrichment)
from paperminer.metadata import clean_doi, crossref_fields as crossref_metadata_fields
...
def pubmed_fields(article: Mapping[str, Any]) -> _Fields:
    ...
    article : Mapping[str, Any]
        Article mapping produced by :func:`paperminer.pubmed.article_to_paper`.
...
def arxiv_fields(entry: Mapping[str, Any]) -> _Fields:
    ...
    entry : Mapping[str, Any]
        Entry mapping produced by :func:`paperminer.arxiv.entry_to_paper`.
...
def medrxiv_fields(entry: Mapping[str, Any]) -> _Fields:
    ...
    ----------
    entry : Mapping[str, Any]
        Record mapping produced by :func:`paperminer.medrxiv.record_to_paper`.
...
def medrxiv_subject_rows(paper_id: str, entry: Mapping[str, Any] | None) -> list[_Record]:
    ...
    entry : Mapping[str, Any] or None
        ...
        :func:`paperminer.medrxiv.record_to_paper`.
...
def biorxiv_fields(entry: Mapping[str, Any]) -> _Fields:
    ...
    ----------
    entry : Mapping[str, Any]
        Record mapping produced by :func:`paperminer.biorxiv.record_to_paper`.
...
def biorxiv_subject_rows(paper_id: str, entry: Mapping[str, Any] | None) -> list[_Record]:
    ...
    entry : Mapping[str, Any] or None
        Record mapping produced by
        :func:`paperminer.biorxiv.record_to_paper`.
...
def chemrxiv_fields(entry: Mapping[str, Any]) -> _Fields:
    ...
    it is normalized by :func:`paperminer.chemrxiv.normalize_chemrxiv_doi`
    rather than by :func:`paperminer.metadata.clean_doi` alone.

    Parameters
    ----------
    entry : Mapping[str, Any]
        Record mapping produced by
        :func:`paperminer.chemrxiv.record_to_paper`.
