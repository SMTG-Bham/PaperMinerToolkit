"""Request helpers for the NCBI E-utilities API used by PaperMiner.

This module centralizes PubMed and PubMed Central HTTP details and the mapping
from PubMed article records onto PaperMiner's paper schema, so search,
...
def article_to_paper(record: ET.Element) -> _PubMedRecord:
    """Map one PubMed record onto PaperMiner's paper schema.
