...
from paperminer.corpus import (PIPELINE_COLUMNS, add_asset, connect,
...
def _pubmed_identifier(paper: Mapping[str, Any]) -> str | None:
    ...
    :func:`paperminer.pubmed.resolve_pmid`, at the cost of one lookup.
...
def _arxiv_identifier(paper: Mapping[str, Any]) -> str | None:
    ...
    wrong record; :func:`paperminer.arxiv.resolve_arxiv_id` offers that
