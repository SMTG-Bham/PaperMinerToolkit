...
from paperscraper.corpus import connect, get_asset
from paperscraper.documents import trim_reference_section
...
def train_topic_model(db_path: str | PathLike[str],
    ...
    if streaming:
        ...
        with tempfile.TemporaryDirectory(
                prefix='paperscraper-topics-', dir=cache_dir) as temporary_dir:
...
def store_topic_model_scores(
    ...
    with tempfile.TemporaryDirectory(prefix='paperscraper-topic-store-') as temporary_dir:
        ...
        with connect(db_path) as conn, sqlite3.connect(staging_path) as staging:
            ...
            try:
                ...
                raise
    try:
        from paperscraper.filtering import refresh_topic_filters
    ...
    try:
        if streaming:
            ...
            temporary = tempfile.TemporaryDirectory(
                prefix='paperscraper-topics-compare-', dir=cache_dir
            )
            prepared = _prepare_streaming_corpus(
