"""Shared HTTP plumbing for the PaperScraper data-source clients.

Every data source PaperScraper reads from -- Crossref, OpenAlex, PubMed,
...
from paperscraper._version import __version__

USER_AGENT = f'PaperScraper/{__version__}'
...
def user_agent(mailto: str = '') -> str:
    ...
    -------
    str
        User agent string identifying PaperScraper and its version.
    """
...
def default_headers(mailto: str = '') -> dict[str, str]:
    ...
    -------
    dict[str, str]
        Headers identifying PaperScraper and its version.
    """
