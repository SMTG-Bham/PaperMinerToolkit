...
PaperScraper searches Crossref, Elsevier/Scopus, CORE, OpenAlex, PubMed, arXiv, medRxiv, and bioRxiv; downloads abstracts, full text, and PDFs; filters papers; and extracts recipe-defined records. Metadata, source documents, processing state, filters, and topic-model predictions live together in a portable SQLite corpus.
